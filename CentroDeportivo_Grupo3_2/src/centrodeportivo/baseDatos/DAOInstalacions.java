...
public final class DAOInstalacions extends AbstractDAO {
    ...
    /**
     * Método que nos permite listar as instalacións da base de datos
     *
     * @return Lista todas as instalacións da base de datos
     */
    public ObservableList<Instalacion> listarInstalacions() {
        //Usaremos un ArrayList para almacenar unha nova instalación:
        ObservableList<Instalacion> instalacions = FXCollections.observableArrayList();
        ...
        try {
            ...
            // Recibida a consulta, procesámola:
            while (rsInstalacions.next()) {
                // Imos engadindo ao ObervableList do resultado cada Instalación consultada:
                instalacions.add(new Instalacion(rsInstalacions.getInt(1), rsInstalacions.getString(2),
                        rsInstalacions.getString(3), rsInstalacions.getString(4)));
            }
